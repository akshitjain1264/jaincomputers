                    ...
                    <div class="col-md-4 col-sm-6 equal-height">
                        <div class="item">
                            ...
                            <div class="info"  style="background-color: rgba(5,199,242,0.15);">
                                ...
                                <div class="footer-meta">
                                    <a class="btn btn-theme effect btn-sm" href="payment.php" style="font-size: 15px;">Buy &#8377;499</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-6 equal-height">
                        <div class="item">
                            ...
                            <div class="info"  style="background-color: rgba(5,199,242,0.15);">
                                ...
                                <div class="footer-meta">
                                    <a class="btn btn-theme effect btn-sm" href="payment.php" style="font-size: 15px;">Buy &#8377;999</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-6 equal-height">
                        <div class="item">
                            ...
                            <div class="info">
                                ...
                                <div class="footer-meta">
                                    <a class="btn btn-theme effect btn-sm" href="payment.php" style="font-size: 15px;">Buy &#8377;1499</a>
                                </div>
                            </div>
                        </div>
                    </div>
